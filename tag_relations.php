...
<div class="container" id='search-container'>
  <div class="page-header">
    <h1>Tagging image &quot;<?php echo $_GET['img']?>&quot;. <small>Select the category:</small></h1>
  </div>


  <div class="row">
    <div class="col-md-8">
       <?php echo "<img  src='http://ecolexicon.ugr.es/visual/imagenes/".$_GET['img']."' class='img-responsive'/>";?>
    </div>
    <div class="col-md-4">
    ...
    <script language=javascript>
      $(function (){
        aunthenticate();
        $('#tag-category').click(tagCategory);
      });
    </script>
